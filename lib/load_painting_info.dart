...
class LoadPaintingInfo {
  ...
  List<PaintingInfo> InitInCode(){
    PaintingInfo item = PaintingInfo(1,'by_the_fire_1.jpg', 'By the Fire', 'Chippewa Camp Scene');
    item.setGawboyDescription('The series of paintings in which fire light was kind of common theme.');
    paintings.add(item);

    item = PaintingInfo(2,'by_the_fire_2.jpg', 'By the Fire', 'Storyteller');
    ...
    item = PaintingInfo(3,'by_the_fire_3.jpg', 'By the Fire', 'Joining the Women');
    ...
    item = PaintingInfo(4,'by_the_fire_4.jpg', 'By the Fire', 'Joining the Women 2');
    ...
    item = PaintingInfo(5,'by_the_fire_5.jpg', 'By the Fire', 'Storyteller 2');
    ...
    item = PaintingInfo(6,'in_the_circle_1.jpg', 'In the Circle', 'Nanboujou and Mishipishu');
    ...
    item = PaintingInfo(7,'in_the_circle_2.jpg', 'In the Circle', 'Lowering the Flag, Ball Club');
    item.setGawboyDescription('This was done in 1993.  The Nanboujou had wounded the great panther curly tail and the great panther offered the riches of world to anyone who could cure him.  ');
    paintings.add(item);

    item = PaintingInfo(8,'in_the_circle_3.jpg', 'In the Circle', 'Veteran’s Farewell');
    item.setGawboyDescription('This was done in 1993.  The Nanboujou had wounded the great panther curly tail and the great panther offered the riches of world to anyone who could cure him.  ');
    paintings.add(item);
